	...
	<q-list link>
		...
		<q-item tag="label">
			...
			<q-item-main>
				...
				<q-item-tile sublabel>BlackJack could be discovered by other devices if enabled (only if Connectable)</q-item-tile>
			</q-item-main>
		</q-item>
		...
		<q-item tag="label">
			...
			<q-item-main>
				...
				<q-item-tile sublabel>Other devices could pair with BlackJack</q-item-tile>
			</q-item-main>
		</q-item>
